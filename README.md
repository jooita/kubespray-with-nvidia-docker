...
### Ansible
    ...
    cp -rfp inventory/sample inventory/gpucluster

    # Update Ansible inventory file
    vi inventory/gpucluster/hosts.ini

    # Review and change parameters under ``inventory/mycluster/group_vars``
    cat inventory/gpucluster/group_vars/all.yml
    cat inventory/gpucluster/group_vars/k8s-cluster.yml
    cat inventory/gpucluster/group_vars/nvidia-docker.yml

    # Deploy Kubespray with Ansible Playbook
    ansible-playbook -i inventory/gpucluster/hosts.ini extra_playbooks/gpu_cluster.yml
